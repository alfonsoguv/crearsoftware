---
title: "¿Cuándo se recuerda un nombre?"
slug: "¿cuando-se-recuerda-un-nombre"
date: "2008-04-10"
oldUrl: "/2008/04/10/%c2%bfcuando-se-recuerda-un-nombre/"
description: "Cinco situaciones en las que un nombre de marca resulta memorable: cuando es diferente, interesante, despierta una imagen mental, una emoción o es simple."
category: "tecnologia-empresarial"
tags: ["marketing","estrategia","gestión empresarial"]
readingTime: 1
...
> Imagen original (Coca-Cola): [Aluminumbottle.jpg](http://en.wikipedia.org/wiki/Image:Aluminumbottle.jpg) — vía [Wikipedia](http://en.wikipedia.org/wiki/Image:Aluminumbottle.jpg).

## Cuando el nombre es diferente o lo suficientemente infrecuente
...
## Cuando tiene algo interesante

**Cuando tiene algo interesante, como por ejemplo una rima, una aliteración o un juego de palabras o humor.** Es el caso de [Coca-Cola](http://en.wikipedia.org/wiki/Coca-Cola "Coca-Cola") y [Toys](http://en.wikipedia.org/wiki/List_of_U.S._state_toys "List of U.S. state toys")"R"Us.

## Cuando despierta una imagen mental
...
## Cuando despierta alguna emoción
