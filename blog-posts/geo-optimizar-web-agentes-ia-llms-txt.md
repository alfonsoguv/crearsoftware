...
description: "Qué es el GEO (Generative Engine Optimization) y cómo preparar tu web para que ChatGPT, Claude, Perplexity y AI Overviews la encuentren y la citen: llms.txt, datos estructurados y robots.txt."
