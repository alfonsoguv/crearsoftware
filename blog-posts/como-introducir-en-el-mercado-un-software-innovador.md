---
title: "¿Cómo introducir en el mercado un software innovador?"
slug: "como-introducir-en-el-mercado-un-software-innovador"
date: "2020-09-29"
oldUrl: "/2020/09/29/como-introducir-en-el-mercado-un-software-innovador/"
description: "Cómo introducir software innovador en el mercado: de innovadores a visionarios, segmentos auto-referenciados y control de expectativas."
category: "tecnologia-empresarial"
tags: ["innovación", "adopción tecnológica", "crossing the chasm", "estrategia", "mercado"]
author: "Alfonso Gutiérrez"
commentCount: 0
wordCount: 743
readingTime: 4
image: "/wp-content/uploads/2020/09/chasm.jpg"
---

![Crossing the Chasm](/wp-content/uploads/2020/09/chasm.jpg)

> El típico problema son demasiadas expectativas combinadas con poco dinero.
>
> *Geoffrey Moore*

Vuelvo al libro que cambió mi vida y que sigue vivo en mí, [Crossing The Chasm](https://amzn.to/3kOHOY2) de [Geoffrey Moore](https://www.amazon.es/gp/search/ref=as_li_qf_sp_sr_il_tl?ie=UTF8&tag=alfonsogu-21&keywords=Geoffrey Moore&index=aps&camp=3638&creative=24630&linkCode=xm2&linkId=8a08cff1201434c054cbee0f26498a1a), un libro que tiene 30 años y que me enseña nuevos lugares cada año.

Una nueva lectura me inspira a escribir cómo introducir en el mercado un software de [innovación discontinua](/2008/03/29/%c2%bfque-es-la-innovacion-discontinua/).
...
- **Que se referencian unos a otros cuando van a tomar una decisión de compra.**

La última parte es la clave que solemos obviar: **un segmento de mercado es mejor cuantas más referencias se produzcan dentro del mismo**. Podemos comprar el mismo producto por la misma razón, pero si no tenemos formas de referenciarnos no hemos seleccionado un buen segmento. Cuanto más auto-referenciado sea el segmento elegido, más potencial de cumplir las primeras fases de adopción. Es importante mantener el momento del segmento antes de pasar al siguiente para crear un efecto carro que haga fácil el desarrollo estratégico.
...
Los innovadores persiguen nuevos productos agresivamente, les gusta encontrar estos productos antes que nadie. El amigo que te enseña la versión beta de iOS, te comparte el último post sobre baterías, te wasapea el enlace del cohete que llegará a Marte, te habla sobre productos que prometen cambiar el mundo. La innovación y la adopción de tecnología es parte central de sus vidas.

El primer año estaremos con versiones alpha; nos faltará documentación, performance y funcionalidad, y la web será una declaración de intenciones. **Los innovadores perdonan las carencias, son los porteros de las nuevas tecnologías, tienen el interés de aprender.**
...
- [Esperanto](https://es.wikipedia.org/wiki/Esperanto). Los innovadores la adoran, pero nadie más es capaz de encontrarle beneficios para empezar a usarla.
- Videoconferencia. En los 90, Xerox, Intel, Picturetel e IBM desarrollaron múltiples tecnologías de videoconferencia; los innovadores estaban enamorados de estos desarrollos, pero el mercado no vio el beneficio real hasta que explotó con el COVID. Entonces se tangibilizó su "beneficio".
