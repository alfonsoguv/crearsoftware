---
title: "Errores no reproducibles en el software"
slug: "errores-no-reproducibles-en-el-software"
date: "2011-06-22"
oldUrl: "/2011/06/22/errores-no-reproducibles-en-el-software/"
description: "Los errores no reproducibles son los bugs más caros de una empresa de software. Cómo reportarlos y buscar patrones para llegar a solucionarlos."
category: "desarrollo-software"
tags: ["bugs","incidencias","no reproducibles","oracle"]
readingTime: 2
...
>
> **Programador:** ¿Estás seguro de que ocurrió eso? —replica el programador, mirándole con cara de "mira que eres usuario".
...
## Notificarlos siempre, buscar patrones

En algunas empresas los programadores ignoran los errores no reproducibles; no obstante, la misión de soporte y testing es notificarlos. Si los damos de alta en la base de datos de bugs, podemos buscar patrones de comportamiento similares en otros errores "no reproducibles".

Si describes el error "no reproducible", seguramente ese mismo bug se ha introducido unas cuantas veces con síntomas diferentes que, juntos, pueden darte pistas de las condiciones por las que no eres capaz de reproducirlo.
