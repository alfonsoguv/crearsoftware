...
description: "OpenAI lanza deep research en ChatGPT: un agente que investiga la web y sintetiza informes al nivel de un analista. Capacidades, benchmarks y limitaciones."
...
![Open AI presenta deep research](/wp-content/uploads/2025/02/freepik__the-style-is-candid-image-photography-with-natural__97974.png)
...
Deep research se entrenó utilizando aprendizaje por refuerzo de extremo a extremo en tareas complejas de navegación y razonamiento en una variedad de dominios. A través de ese entrenamiento, aprendió a planificar y ejecutar una trayectoria de múltiples pasos para encontrar los datos que necesita, retrocediendo y reaccionando ante información en tiempo real cuando es necesario.
...
| --- | --- | --- | --- | --- |
| SOTA anterior (se abre en una ventana nueva) | 67.92 | 67.44 | 42.31 | |
| Deep Research (pass@1) | 74.29 | 69.06 | 47.6 | |
| Deep Research (cons@64) | 78.66 | 73.21 | 58.03 | |
