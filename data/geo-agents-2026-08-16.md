...
Fecha de generacion: 2026-08-16T07:06:51.820Z
Origen: https://crearsoftware.com
Ventana: ultimos 28 dias
Peticiones de agentes contabilizadas: 5209

## Por familia

| Familia | Peticiones | Por que importa |
| --- | --- | --- |
| Búsqueda generativa | 1940 | Construyen el indice que el modelo consulta al responder |
| Buscador clásico | 784 | SEO tradicional, referencia de comparacion |
| Entrenamiento | 2353 | Alimentan el conocimiento base del modelo |
| Agentes en vivo | 132 | Visitan porque un usuario esta preguntando ahora: generan la cita |

## Por agente

| Agente | Familia | Peticiones |
| --- | --- | --- |
| Bingbot | Búsqueda generativa | 1522 |
| GPTBot | Entrenamiento | 1344 |
| Amazonbot | Entrenamiento | 915 |
| Googlebot | Buscador clásico | 784 |
| PerplexityBot | Búsqueda generativa | 406 |
| ChatGPT-User | Agentes en vivo | 116 |
| ClaudeBot | Entrenamiento | 83 |
| Claude-User | Agentes en vivo | 13 |
| OAI-SearchBot | Búsqueda generativa | 10 |
...
| --- | --- |
| / | 216 |
| /2025/02/13/novedades-de-alexa-la-ia-generativa-revoluciona-asistentes-de-voz/ | 172 |
| /blog/ | 155 |
| /2007/06/23/ejemplos-de-input-output-y-actividades/ | 51 |
| /2025/03/29/plataformas-de-agentes-de-voz-con-ia-en-europa-especial-foco-en-espana/ | 42 |
| /blog/servir-markdown-agentes-ia-md-por-url/ | 22 |
| /blog/geo-optimizar-web-agentes-ia-llms-txt/ | 21 |
| /llms.txt | 19 |
| /guia/guia-agentes-ia-empresas/ | 17 |
| /2008/05/18/%C2%BFcual-es-la-historia-del-corte-ingles/ | 17 |
| /2012/04/04/como-crear-programas/ | 16 |
| /wp-content/uploads/ | 16 |
| /blog/montar-agente-de-voz-ia-que-atienda-llamadas/ | 15 |
| /2009/03/22/la-venta-personal-en-internet-saas-paas/ | 14 |
| /guia/guia-ia-generativa-creacion-contenido/ | 13 |
| /2025/04/14/la-guia-definitiva-sobre-el-protocolo-de-contexto-del-modelo-mcp/ | 13 |
| /guia/guia-desarrollo-software-moderno/ | 12 |
| /sobre/ | 12 |
| /2008/03/12/%C2%BFque-es-un-producto/ | 12 |
| /guia/guia-herramientas-productividad-2026/ | 11 |

## Formato servido (md vs HTML)

| Familia | Markdown | llms.txt | HTML | % Markdown | Sin medir |
| --- | --- | --- | --- | --- | --- |
| Búsqueda generativa | 3 | 1 | 224 | 1.3% | 1712 |
| Buscador clásico | 0 | 3 | 210 | 0.0% | 571 |
| Entrenamiento | 510 | 3 | 909 | 35.9% | 931 |
| Agentes en vivo | 0 | 0 | 64 | 0.0% | 68 |
